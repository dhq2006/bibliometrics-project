...
- 成员:
​
- B: 负责文献检索策略制定、数据采集与预处理（检索式构建、数据导出与清洗）
​
- C: 负责文献筛选流程设计、PRISMA报告撰写与研究空白分析
​
- D: 负责数据质量评估、图数据模型构建与数据清洗规则制定
​
- E: 负责计量分析指标定义、知识图谱可视化与最终报告撰写及汇报
 
研究方向
本项目聚焦于生成式人工智能（AIGC）在科学研究领域的应用与发展趋势，旨在通过文献计量学与知识图谱分析方法，系统梳理该领域的研究热点、核心技术演进路径、关键研究团队与机构合作网络，揭示其在各学科中的应用模式与未来发展方向。
